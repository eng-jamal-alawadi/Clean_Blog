                    ...
                    <div class="col-md-10 col-lg-8 col-xl-7">
                        <ul class="list-inline text-center">
                            <li class="list-inline-item">
                                <a href="https://twitter.com/JamalAlawadi3">
                            ...
                            <li class="list-inline-item">
                                <a href="https://github.com/eng-jamal-alawadi">
                                    <span class="fa-stack fa-lg">
                                        <i class="fas fa-circle fa-stack-2x"></i>
                        ...
                        <div class="small text-center text-muted fst-italic">Copyright &copy; Jamal A. Alawadi 2021</div>
                    </div>
                </div>
            </div>
        </footer>
