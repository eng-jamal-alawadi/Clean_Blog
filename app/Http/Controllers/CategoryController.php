...
class CategoryController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('clean_blog.admin.categories.index',compact('categories'));
    }
    ...
    {
        return view('clean_blog.admin.categories.create');
    }
    ...
    public function edit($id)
    {
        ...
        return view('clean_blog.admin.categories.edit',compact('category'));
    }
